...
<a class="button is-dark is-medium" title="Clone the GitHub repo" href="didact://?commandId=vscode.didact.sendNamedTerminalAString&text=Python$$python3+deleteDeploy.py">Delete deployment</a><br>
